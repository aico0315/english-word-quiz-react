...
export default function QuestionScreen({ className, onReturn, onDisplay, onCurrentWordArray, onCurrentIndex, value, setUserInput, selectedCategory }: QuestionScreenProps){
